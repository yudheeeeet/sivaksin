                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-8 col-xxl-12">
                                    <div class="text-center text-xl-left text-xxl-center px-4 mb-4 mb-xl-0 mb-xxl-4">
                                        ...
                                        @endif
                                        <div>
                                            <form action="/admin/posko/{{ $posko->id }}" method="POST" enctype="multipart/form-data" style="width: 900px">
                                                @method('put')
                                                @csrf
                                                <div class="mb-3" >
                                                    <label>Nama Posko</label>
                                                    <input class="form-control" name="nama_posko" value="{{ $posko->nama_posko }}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Alamat</label>
                                                    <input class="form-control" name="alamat" value="{{ $posko->alamat }}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Latitude</label>
                                                    <input class="form-control" name="latitude" value="{{ $posko->latitude }}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Longitude</label>
                                                    <input class="form-control" name="longitude" value="{{ $posko->longitude }}">
                                                </div>
