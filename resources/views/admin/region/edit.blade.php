                                        ...
                                        <div>
                                            <form action="/admin/region/{{ $region->id }}" method="POST" enctype="multipart/form-data" style="width: 900px">
                                                ...
                                                <div class="mb-3" >
                                                    ...
                                                    <input class="form-control" name="nama_desa" value="{{ $region->nama_desa }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleFormControlTextarea1" class="form-label">Lokasi Spasial</label>
                                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="geojson" rows="10">
                                                        {{ $region->geojson }}
                                                    </textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>Jumlah Sasaran Tervaksinasi</label>
                                                    <input class="form-control" name="jumlah_sasaran" value="{{ $region->jumlah_sasaran }}">
                                                </div>
