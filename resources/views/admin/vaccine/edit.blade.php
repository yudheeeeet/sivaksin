                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-8 col-xxl-12">
                                    <div class="text-center text-xl-left text-xxl-center px-4 mb-4 mb-xl-0 mb-xxl-4">
                                        ...
                                        @endif
                                        <div>
                                            <form action="/admin/vaccine/{{ $vaccine->id }}" method="POST" enctype="multipart/form-data" style="width: 900px">
                                                @method('put')
                                                @csrf
                                                <div class="form-group">
                                                    <label for="exampleFormControlSelect1">Pilih Kategori Vaksin</label>
                                                    <select class="form-control" id="exampleFormControlSelect1" name="kategori">
                                                        <option>{{ $vaccine->kategori }}</option>
                                                ...
                                                <div class="mb-3" >
                                                    ...
                                                    <input class="form-control" name="jenis_vaksin" value="{{ $vaccine->jenis_vaksin }}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Jumlah Sasaran Tervaksinasi</label>
                                                    <input class="form-control" name="stock" value="{{ $vaccine->stock }}">
                                                </div>
