                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-8 col-xxl-12">
                                    <div class="text-center text-xl-left text-xxl-center px-4 mb-4 mb-xl-0 mb-xxl-4">
                                        ...
                                        @endif
                                        <div>
                                            <form action="{{route('vaccine.store')}}" method="POST" enctype="multipart/form-data" style="width: 900px">
                                                @csrf
                                                ...
                                                <div class="mb-3" >
                                                    ...
                                                    <input class="form-control" name="jenis_vaksin">
                                                </div>
                                                <div class="form-group">
                                                    <label>Stok Vaksin</label>
