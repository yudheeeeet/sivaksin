                ...
                <div class="card mb-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('results.show', $item->id) }}" class="btn btn-success">Lihat Hasil Kegiatan</a> <a href="{{ route('results.edit', $item->id) }}" class="btn btn-primary">Kelola Hasil Kegiatan</a> <a href="{{ route('event.edit', $item->id) }}" class="btn btn-warning">Ubah Jadwal</a>
                        </div>
                    </div>
                </div>
                @endforeach
