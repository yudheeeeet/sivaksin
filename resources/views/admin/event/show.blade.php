                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-8 col-xxl-12">
                                    <div class="text-center text-xl-left text-xxl-center px-4 mb-4 mb-xl-0 mb-xxl-4">
                                        ...
                                        @endif
                                        <div>
                                            <form action="{{ route('event.store') }}" method="POST" enctype="multipart/form-data" style="width: 900px">
                                                @csrf
                                                <div class="form-group">
                                                    <label>Nama Posyandu</label>
                                                    <input class="form-control" value="{{ $posko->nama_posko }}">
                                                </div>   
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="datetime-local" name="tanggal_kegiatan">
                                                </div>
                                                <div class="form-group">
                                                    <label>Petugas</label>
                                                ...
                                                <div class="mb-3" >
                                                    <label></label>
                                                    <input class="form-control" type="hidden" name="posko_id" value="{{ $posko->id }}">
                                                </div>
