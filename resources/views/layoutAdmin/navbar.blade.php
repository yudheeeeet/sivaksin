        ...
        <nav class="sidenav shadow-right sidenav-light">
            <div class="sidenav-menu">
                <div class="nav accordion" id="accordionSidenav">
                    ...
                    <div class="collaps {{ Request::segment(2) == 'region' || Request::segment(2) == 'spasial' || Request::segment(2) == 'vaccine' ? 'active show' : '' }}" id="collapseDashboards" data-parent="#accordionSidenav">
                        <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                            <a class="nav-link {{ Request::segment(2) == 'region' ? 'active' : '' }}" href="{{ route('region.index') }}">
                                Data Desa
                            </a>
                            <a class="nav-link {{ Request::segment(2) == 'spasial' ? 'active' : '' }}" href="{{ route('spasial') }}">
                                Daftar Spasial Desa
                            </a>
